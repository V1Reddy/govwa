...
type User struct{} //oop like syntax

func (self *Self) SetRouter2(r *httprouter.Router) {
	/* register all router */
...
func LoginViewHandler2(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
...
func loginAction2(w http.ResponseWriter, r *http.Request, _ httprouter.Params) bool {
...
func Logout2(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	s := session.New()
	s.DeleteSession(w, r)
...
func validateForm2(w http.ResponseWriter, r *http.Request, _ httprouter.Params)bool{
	uname := r.FormValue("username")
...
func checkUserQuery2(username, pass string) *UserData2 {
	...
	var uData = UserData2{} //inisialize empty userdata
...
func Md5Sum2(text string) string {
	hasher := md5.New()
